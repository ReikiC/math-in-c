---
name: ipynb-notebook
description: Create, edit, and manipulate Jupyter (.ipynb) notebooks programmatically — building notebooks cell-by-cell, editing cells by ID, inserting/deleting cells, and emitting valid notebook JSON. Use whenever the task involves writing or restructuring a .ipynb file.
---
